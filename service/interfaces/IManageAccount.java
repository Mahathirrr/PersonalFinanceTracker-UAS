 ...
 * Provides operations for creating, retrieving, updating, and deleting accounts.
 */
public interface IManageAccount {
     ...
     * @throws SecurityException if the user is not authorized to access the account.
     */
     ...
     * @throws ValidationException if the input data is invalid (e.g., name is empty).
     * @throws NotFoundException if the user is not found.
     */
    UUID createAccount(UUID userId, String name, BigDecimal balance, String type) throws ValidationException, NotFoundException;
     ...
     * @throws NotFoundException if the account or user is not found.
     * @throws SecurityException if the user is not authorized to update the account.
     */
    boolean updateAccount(UUID accountId, UUID userId, String name, String type, boolean isActive) throws ValidationException, NotFoundException, SecurityException;
     ...
     * @throws ValidationException if deletion is not allowed (e.g., account has transactions).
     */
