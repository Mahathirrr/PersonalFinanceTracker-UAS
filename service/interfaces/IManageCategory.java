...
public interface IManageCategory {
    ...
    /**
     * Retrieves a list of all categories available to a user (or globally, depending on design).
     ...
     * @throws ValidationException if the input data is invalid (e.g., name is empty, type is invalid, name already exists for the type).
     */
     ...
     * @throws NotFoundException if the category is not found.
     */
    boolean updateCategory(UUID categoryId, String name, String type, String icon) throws ValidationException, NotFoundException;

    /**
     * Deletes an existing category.
     * Note: Consider implications if the category is used in transactions or budgets.
     * The implementation might prevent deletion or require confirmation/reassignment.
     *
     * @param categoryId The ID of the category to delete.
     * @return true if the deletion was successful, false otherwise.
     * @throws NotFoundException if the category is not found.
     * @throws ValidationException if deletion is not allowed (e.g., category is in use).
     */
