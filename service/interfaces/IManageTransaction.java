 ...
 * Provides operations for creating, retrieving, updating, and deleting transactions.
 */
public interface IManageTransaction {
     ...
     * @param filters A map containing filter criteria (e.g., accountId, categoryId, date range, type).
     ...
     * @param userId The ID of the user owning the transaction (for authorization).
     * @return The Transaction object.
     * @throws NotFoundException if the transaction or user is not found.
     * @throws SecurityException if the user is not authorized to access the transaction.
     */
     ...
     * @param amount The amount of the transaction (positive for income, negative for expense).
     * @param date The date of the transaction.
     * @param description A description of the transaction.
     * @param type The type of transaction ("income" or "expense").
     * @return The ID of the newly created transaction.
     * @throws ValidationException if the input data is invalid (e.g., amount is zero, category doesn't match type).
     * @throws NotFoundException if the user, account, or category is not found.
     * @throws SecurityException if the user is not authorized to use the account/category.
     */
    UUID createTransaction(UUID userId, UUID accountId, UUID categoryId, BigDecimal amount, LocalDate date, String description, String type)
     ...
     * @throws NotFoundException if the transaction, user, account, or category is not found.
     * @throws SecurityException if the user is not authorized to update the transaction or use the account/category.
     */
    boolean updateTransaction(UUID transactionId, UUID userId, UUID accountId, UUID categoryId, BigDecimal amount, LocalDate date, String description)
            throws ValidationException, NotFoundException, SecurityException;

    /**
     * Deletes an existing transaction.
     * This operation should also reverse the effect on the associated account balance.
     *
     * @param transactionId The ID of the transaction to delete.
     * @param userId The ID of the user owning the transaction (for authorization).
     * @return true if the deletion was successful, false otherwise.
     * @throws NotFoundException if the transaction or user is not found.
     * @throws SecurityException if the user is not authorized to delete the transaction.
     */
