...
public interface IManageBudget {
     ...
     * @throws ValidationException if the input data is invalid (e.g., name is empty, amount is negative, dates are invalid, categories are invalid).
     * @throws NotFoundException if the user or any specified category is not found.
     * @throws SecurityException if the user is not authorized to use the categories.
     */
    UUID createBudget(UUID userId, String name, BigDecimal amount, LocalDate startDate, LocalDate endDate, List<UUID> categoryIds)
     ...
     * @throws NotFoundException if the budget, user, or any specified category is not found.
     * @throws SecurityException if the user is not authorized to update the budget or use the categories.
     */
    boolean updateBudget(UUID budgetId, UUID userId, String name, BigDecimal amount, LocalDate startDate, LocalDate endDate, List<UUID> categoryIds, boolean isActive)
            throws ValidationException, NotFoundException, SecurityException;
