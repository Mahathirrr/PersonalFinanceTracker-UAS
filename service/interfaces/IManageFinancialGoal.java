...
public interface IManageFinancialGoal {
         ...
         *                             empty, target amount is non-positive, current
         *                             amount exceeds target, deadline is in the past).
         * @throws NotFoundException   if the user is not found.
         */
        UUID createFinancialGoal(UUID userId, String name, BigDecimal targetAmount, BigDecimal currentAmount,
                        LocalDate deadline)
         ...
         */
        boolean updateFinancialGoal(UUID goalId, UUID userId, String name, BigDecimal targetAmount,
         ...
         * @throws NotFoundException   if the goal or user is not found.
         * @throws SecurityException   if the user is not authorized to contribute to
         *                             the goal.
         */
        boolean addContribution(UUID goalId, UUID userId, BigDecimal amount)
                        throws ValidationException, NotFoundException, SecurityException;
